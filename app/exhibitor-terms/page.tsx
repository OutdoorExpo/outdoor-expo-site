...
export const metadata = {
  title: "Exhibitor Terms & Conditions",
  description:
    "Terms & Conditions for exhibitors at Outdoor Expo — application, payment, exhibits, animals, health & safety, and more.",
};

export default function ExhibitorTermsPage() {
  return (
    <LegalLayout title="Exhibitor Terms & Conditions">
      <h2>1. Definitions</h2>
      <p>
        <strong>Application</strong> means the Show&rsquo;s Trade Application Form which Exhibitors (and/or sub-let exhibitors) complete and return to the Society to apply for a Site at the Show binding them to these Terms.
      </p>
      <p>
        <strong>Exhibitor(s)</strong> means an exhibitor (and includes any sub-let exhibitor) who has submitted an Application for a Site at the Show and includes all employees, agents or contractors of any individual, partnership or company applying/exhibiting.
      </p>
      <p><strong>Show</strong> means the Outdoor Expo.</p>
      <p><strong>Showgrounds</strong> means the location on which the Show is held in Christchurch.</p>
      <p><strong>Site</strong> means a trade site to exhibit goods/services at the Outdoor Expo.</p>
      <p>
        <strong>Board</strong> means the Outdoor Expo directors and includes any authorised officer appointed by the Board.
      </p>
      <p><strong>Terms</strong> means these Terms &amp; Conditions.</p>
      <p>
        <strong>Trade Prospectus</strong> means the Show&rsquo;s Trade Prospectus available to Exhibitors and which provides relevant information for Exhibitors.
      </p>

      <h2>2. Application</h2>
      <p>2.1. By submitting an Application Exhibitors agree to these Terms.</p>
      <p>2.2. The Board may accept or decline any Application at its sole discretion.</p>
      <p>
        2.3. Upon application exhibitors will be invoiced for the full amount of the applicable site fees, a non-refundable deposit of 20% of the total invoice amount is required to confirm the booking. This is to be paid within the specified time frame or site application will be forfeited, this amount will be refunded to the exhibitor if the Board is unable to offer a site to the exhibitor.
      </p>
      <p>
      ...
      <p>
        6.2. All dogs must be kept on a leash at all times while on the Showgrounds, with the exception of dogs actively involved in official demonstrations. This includes guide dogs, service dogs, and other working dogs. Exhibitors are responsible for ensuring that any dogs associated with their site are properly restrained and under control at all times.
      </p>
      <p>
        6.3. Exhibitors bringing horses to the Showgrounds must ensure they are securely contained at all times and under the supervision of experienced handlers. Horses may only be ridden or led in designated areas, and must not be left unattended or tethered in public accessways.
      </p>
      <p>Exhibitors are responsible for:</p>
      <ul>
        <li>Providing safe and secure fencing or containment for their horses</li>
        <li>Cleaning up all manure and waste from stables, yards, and demonstration areas</li>
        <li>Ensuring safety during any riding or handling demonstrations, with appropriate barriers or controls in place to manage public interaction</li>
        <li>Complying with all relevant animal welfare legislation and health and safety regulations</li>
      </ul>
      <p>The safety of both animals and the public is a top priority. Non-compliance may result in removal from the event.</p>
      <p>
        6.4. Good animal husbandry practices must be displayed or Show staff may ask you to remove the exhibit in question.
      </p>
      ...
      <p>
        7.2. It is the Exhibitor&rsquo;s responsibility to ensure the electrical contract is accurately completed with all necessary power requirements clearly stated, including if overnight power is required.
      </p>
      <p>
      ...
      <p>7.4. Generators provided by exhibitors are prohibited.</p>

      <h2>8. Exhibitor Warranties</h2>
      <p>8.1. All Exhibitor&rsquo;s warrant that:</p>
      <ul>
        <li>they will operate the Site in a proper and professional manner and will ensure that the Site is properly staffed by competent representatives;</li>
        <li>they will operate the Site in compliance with all of the Society&rsquo;s policies, procedures and requirements, as advised by the Society at any time;</li>
        <li>keep the Site properly maintained and cleaned, and keep passageways adjacent to its Site free from obstruction;</li>
        <li>at all times its conduct will not bring discredit to the Show or the Board or cause any nuisance or disruption to the Show or the Board;</li>
        <li>they have the authority to enter into and perform its obligations under these Terms and these Terms constitute its legal, valid and binding obligations enforceable in accordance with its terms.</li>
      </ul>
      ...
      <p>9.2. All Exhibitors must take out and maintain during the Show the following policies of insurance with a reputable insurer:</p>
      <ul>
        <li>public liability insurance for an amount not less than $1,000,000; and</li>
        <li>ensure that all workers have ACC workers&rsquo; cover and for persons who are not eligible for ACC workers&rsquo; cover, workers compensation insurance in respect of all employees and contractors of the Exhibitor, proof of this cover is to be produced by the Exhibitor if requested by the Board.</li>
      </ul>

      <h2>10. Security and Vehicles</h2>
      <p>
      ...
      <p>11.2. Additional tickets may be purchased online via the Show website.</p>
      <p>11.3. No entry is permitted to the Show without a ticket.</p>
      ...
      <p>
        12.2. Exhibitors must comply with local body bylaws, all laws, regulations and policies (including, without limitation, Health and Safety at Work Act 2015 (HSWA), HSWA Regulations and laws related to the preparation and distribution of food and beverage items) which govern the erection of structures, the display and/or sale of machinery, vehicles and/or other products or goods of the Exhibitors.
      </p>
      <p>
      ...
      <p>12.4. Exhibitors are responsible for preparing and monitoring a Health and Safety audit for their Site.</p>
      <p>12.5. Exhibitors are required to have suitable, approved fire extinguishers on their stand at all times.</p>
      <p>12.6. Any fire or BBQ appliance used by an Exhibitor must be fire safe compliant.</p>
      <p>
      ...
      <p>12.8. Exhibitors acknowledge that the Outdoor Expo is a smoke and vape free event.</p>
      <p>
      ...
      <p>12.10. Each Exhibitor must keep all display equipment and signs within their allocated Site boundaries.</p>
      <p>12.11. All tent and marquee pegs must be covered with sandbags or shrubs, same as other dangerous spikes or protruding objects.</p>
      <p>12.12. Exhibitors must ensure that they keep walkways clear and no dangerous equipment or chemicals are accessible to the public.</p>
      <p>12.13. The First Aid Station is located beside the show grounds A&amp;P office.</p>
      <p>12.14. All Accidents, incidents and hazards. Refer to the Health and Safety Policy.</p>
      <p>
      ...
      <p>
        12.16. Vendors operating amusements must fill out a Form 4: Amusement Device Regulation available from Christchurch City Council and submit with applicable fee before the Show begins.
      </p>
      <p>
      ...
      <p>
        13.2. The Exhibitor acknowledges that the Board has adopted a &ldquo;No glass&rdquo; policy for Exhibitors offering hospitality.
      </p>
      <p>
        13.3. Exhibitors offering hospitality must apply the Host Responsibility Policy and be responsible hosts. The Board accepts no responsibility for an Exhibitor&rsquo;s guests.
      </p>
      <p>13.4. The sale of food or confectionery lines, other than from approved outlets is prohibited.</p>
      <p>
      ...
      <h2>14. Liquor / Alcohol</h2>
      <p>
        14.1. All exhibitors who wish to sell alcohol or supply must obtain a special license. Please contact Christchurch City Council on 03 941 8999 or email{" "}
        <a href="mailto:alcohollicensing@ccc.govt.nz">alcohollicensing@ccc.govt.nz</a>. Applications can be made via the CCC website:{" "}
        <a
          href="https://ccc.govt.nz/consents-and-licences/business-licences-and-consents/alcohol/"
          target="_blank"
          rel="noopener noreferrer"
        >
          ccc.govt.nz/consents-and-licences/business-licences-and-consents/alcohol
        </a>
      </p>
      <p>14.2. No alcohol can be served or supplied outside your permitted Liquor Licence times.</p>
      <p>14.3. No opened alcohol is allowed off any Site.</p>

      <h2>15. Advertising</h2>
      <p>15.1. Any Exhibitor interested in sponsorship and advertising opportunities should contact the Board.</p>
      <p>
      ...
      <h2>16. Signage, Structures, and the Building Act</h2>
      <p>
      ...
      <h2>17. Use of Exhibitor Information and the Privacy Act</h2>
      <p>17.1. By completing the Application, the Exhibitor agrees and acknowledges that:</p>
      <ul>
        <li>Exhibitor details can be used as part of the Board&rsquo;s information;</li>
        <li>Exhibitor details can be made available to the media for use in compiling the Show newspaper supplements, for human interest stories, as well as for programme preparation and for the Board to use in promotional and educational material about the Show;</li>
        <li>Exhibitor details can be made available to nominated companies that exhibit resource materials, where the Society believes them to be reputable.</li>
        <li>Exhibitor details given to the Board on the Application will be directly transferred and used as the company listing in the Trade Exhibitors list in the Show programme. Exhibitors should clearly state the correct company name which will be publicised;</li>
        <li>Exhibitors give consent to the Board to take and use photographs, images and any video footage of the Exhibitor, or the Exhibitor&rsquo;s Site during the Show in perpetuity in any media without payment to the Exhibitor.</li>
      </ul>
      <p>
      ...
      <h2>18. Removal</h2>
      <p>
        18.1. Exhibitors agree that they will not commence dismantling their Site or remove any displays from the Showgrounds until after 4:30pm Sunday. All Sites are to be returned to the original condition. Displays must be completely removed from the Showgrounds by 4pm on the Wednesday after the Show. Exhibitors acknowledge that security finishes at 8:00am on Monday after the Show.
      </p>
      <p>
        18.2. Exhibitors whose items remain on the property after 4pm on the Wednesday after the Show will be liable for all costs incurred (legal or otherwise) plus a storage fee of $50 per day until the items are removed from the Showgrounds.
      </p>
      <p>
      ...
      <h2>19. Termination or Cancellation</h2>
      <p>
        19.1. Should an Exhibitor be unable or unwilling to perform its part of these Terms or fail to comply with these Terms, or any of the Board&rsquo;s policies, or otherwise be in breach of these Terms, the Board may terminate these Terms by giving notice in writing. The Exhibitor shall thereafter be prohibited from occupying its Site and shall immediately remove its exhibits from the Showgrounds in accordance with the Board&rsquo;s directions.
      </p>
      <p>
      ...
      <p>
        21.2. The Exhibitor acknowledges that the Board does not make any representation or give any warranty with respect to the Show, including as to the success or profitability for the Exhibitor in participating in the Show, the number or type of clientele that will visit the Show and/or the suitability of their exhibit/products for the Show.
      </p>
      <p>21.3. To the extent permitted by law, the Board excludes all warranties regarding the Site and/or the Show whatsoever.</p>
      <p>
        21.4. The Board&rsquo;s liability under these Terms is limited to the fees actually paid by the Exhibitor to the Board. In no circumstances will the Board be liable to the Exhibitor for any indirect, incidental, special and/or consequential losses or damages (including loss of profits or opportunity) arising directly or indirectly in connection with the Show.
      </p>
      <p>21.5. All refunds are minus the booking fee/s.</p>
      ...
      <ul>
        <li>the Exhibitor&rsquo;s operation of the Site at the Show and/or participation in the Show;</li>
        <li>the sale and/or distribution (whether for payment or otherwise) of any products by the Exhibitor on the Site;</li>
        <li>any act or omission of the Exhibitor;</li>
        <li>any breach of any laws by the Exhibitor; and</li>
        <li>any breach of these Terms by the Exhibitor.</li>
      </ul>

      <h2>23. Force Majeure</h2>
      <p>
        23.1. The Board will not be liable for any delay or failure to perform its obligations to the extent that such delay or failure results from a Force Majeure Event and while the Force Majeure Event continues. The Board will give the Exhibitor written notice as soon as reasonably possible containing details of the circumstances giving rise to the Force Majeure Event. The Exhibitor acknowledges and agrees that it will not be entitled to any reimbursement of any fees paid where a Force Majeure Event disrupts the Show. The Board may in its absolute discretion refund in whole or in part, any payment made by the Exhibitor — or waive any payment the Exhibitor is liable to make under these Terms.
      </p>
      <p>
        23.2. For the purposes of clause 23.2 above, &ldquo;Force Majeure&rdquo; means an event or occurrence which is beyond a party&rsquo;s reasonable control (including, without limitation, acts of God or the public enemy, flood, earthquake, storm, cyclone, tornado, hurricane, lightning, fire, explosion, epidemic, war, embargoes, riot or civil disturbances, sabotage, expropriation, confiscation or requisitioning of facilities, the imposition of disabling exchange rate controls, orders or temporary or permanent injunctions of any duly constituted court of competent jurisdiction); and which the affected party could not have reasonably foreseen or taken reasonable measures to prevent.
      </p>
      ...
      <p>24.3. The Board may assign its rights and obligations under these Terms to any person without the consent of the Exhibitor.</p>
      <p>
        24.4. Words in the singular number only shall include the plural and vice versa and words importing gender shall include the masculine feminine and neuter genders and words importing persons shall include firms and companies, corporations, partnerships and all other forms of organisation and trusts and references to a party include that party&rsquo;s personal representatives or successors and permitted assigns.
      </p>
      <p>24.5. When two or more persons are parties to these Terms, the Terms shall bind them jointly and each of them separately.</p>
